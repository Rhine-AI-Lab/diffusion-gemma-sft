...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset", type=str, choices=["countdown", "sudoku"], default="countdown"
    )
    ...
    if args.checkpoint_path:
        model = PeftModel.from_pretrained(model, args.checkpoint_path, torch_dtype=torch.bfloat16, torch_device=local_rank)
